...
- The perfered OS is Ubuntu
- Pyhton
- pip, pytest and requests
- Docker

Before assessing the files, please download the files and place them in a newly created folder named App.
...
Question 1: Add 1 line of code to the function in question1.py to let the output print 4 and run.
	...
	1. Open Terminal
	2. Navigate to the folder named App
	3. In terminal enter: python3 Q1_Answer.py
...
Question 2: Use pytest to make the function in question2.py run.
	...
	1. Open Terminal
	2. Navigate to the folder named App
	3. In terminal enter: pytest test_Q2.py 

	This will return with with a fail, you can see in the test answer that 4 does not equal 5. To fix this,a duplicate file was created and named test_Q2Answer.py, the parameter x has been changed to 4. 

	How to test the updated script: 
	1. Within the same terminal session enter: pytest test_Q2Answer.py 
...
Question 4: Create a docker image of the python script where you input the environment variables for the script to use and then run it to display the total time.
	...
	Answer: A Dockerfile has been created to run the script that was created in Question 3. The docker file determines the the environment variables, which is used by the script. 

	How to deploy assessment docker: 
	1. Open Terminal
	2. Navigate to the folder named App
